...
urlpatterns = [
    ...
    url(
        r"^create_from_checklist/(?P<checklist_id>\d+)$",
        views.create,
        name="create_from_checklist",
    ),
    ...
    url(
        r"^(?P<template_id>\d+)/items/(?P<item_id>\d+)/delete/$",
        views.item_delete,
        name="item_delete",
    ),
    url(
        r"^(?P<template_id>\d+)/items/(?P<source_id>\d+)/(?P<destination_id>\d+)/$",
        views.item_swap,
        name="item_swap",
    ),
]
